...
class Member:    
    ...
    def set_father(self, father):
        ...
        if father.gender != Gender.male:
            raise ValueError(
                "Invalid Gender for father" 
            )
        self.father = father
         
    def set_spouse(self, spouse):
        if not isinstance(spouse, Member):
            raise ValueError("Invalid value fopr spouse")
        if self.gender == spouse.gender:
            raise ValueError(
                "Invalid Gender for spouse" 
            )
        self.spouse = spouse
    ...
    def set_child(self, child):
        if not isinstance(child, Member):
            raise ValueError("Invalid value fopr spouse")
        if self.gender == child.gender:
            raise ValueError(
                "Invalid Gender for child" 
            )
